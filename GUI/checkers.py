...
#Dibujar el botón
def draw_button(screen, is_rotation_enabled):
    button_color = (0, 200, 0) if is_rotation_enabled else (200, 0, 0)
    button_text = "Rotation: ON" if is_rotation_enabled else "Rotation: OFF"

    pygame.draw.rect(screen, button_color, (650, 20, 120, 40))
    font = pygame.font.SysFont("Arial", 18)
    text_surface = font.render(button_text, True, WHITE)
    screen.blit(text_surface, (660, 30))
