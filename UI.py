...
def main():
    ...
    red_checkers = [(row, col) for row in range(0, 3) for col in range(row % 2, BOARD_SIZE, 2)]
    black_checkers = [(row, col) for row in range(5, 8) for col in range(row % 2, BOARD_SIZE, 2)]
